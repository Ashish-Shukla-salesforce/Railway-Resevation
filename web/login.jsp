...
<div class="container">    
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 30px" class="input-group">
                                        ...
                                        <input id="login-username" type="text" class="form-control" name="userid" value="" placeholder="user ID or email">                                        
                                    </div>
    ...
    if(request.getParameter("add")!=null)
    {
            ...
            String s="Select * from account where user_id='"+userid+"' and password='"+password+"' or email='"+email+"' and password='"+password+"'";
     ...
     {
         out.println("<script>alert('user ID or email or password typed incorrect');</script>");
